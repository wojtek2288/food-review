...
export const UserCard: React.FC<UserCardProps> = ({ user, navigation }) => {
  const onUserCardClicked = () => {
    navigation.navigate('UserDetailsScreen', { userId: user.id });
  };
  return (
    <View style={styles.userContainer}>
      <Card style={styles.card} onPress={onUserCardClicked}>
